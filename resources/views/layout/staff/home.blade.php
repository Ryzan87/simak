...
<div class="product-unduhan-area mg-tb-30">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                <div class="product-unduhan-chart">
...
<script>
    ...
    const ctx = document.getElementById('unduhanChart').getContext('2d');
    const unduhanChart = new Chart(ctx, {
