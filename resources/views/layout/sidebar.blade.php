        ...
        <div class="left-custom-menu-adp-wrap comment-scrollbar">
            ...
            <nav class="sidebar-nav left-sidebar-menu-pro" style="margin-top: 30px">
                ...
                <ul class="metismenu" id="menu1">
                    ...
                    <li>
                        <a href="{{ route('calon-mahasiswa.index') }}" aria-expanded="false"><span
                    ...
                    <li>
                        <a href="{{ route('agen-sekolah.index') }}" aria-expanded="false"><span
                                class="educate-icon educate-course icon-wrap sub-icon-mg" aria-hidden="true"></span>
                            <span class="mini-click-non">Data Agen Sekolah</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="/kategori" aria-expanded="false"><span
                                class="educate-icon educate-course icon-wrap sub-icon-mg" aria-hidden="true"></span>
                            <span class="mini-click-non">Data Kategori</span></a>
                    </li>
                    <li>
                        <a href="/arsip" aria-expanded="false"><span
                                class="educate-icon educate-data-table icon-wrap sub-icon-mg" aria-hidden="true"></span>
                            <span class="mini-click-non">Data Arsip</span></a>
                    </li>
                    <li>
                        <a href="/staff" aria-expanded="false"><span
                                class="educate-icon educate-professor icon-wrap sub-icon-mg" aria-hidden="true"></span>
                            <span class="mini-click-non">Staf Marketing</span></a>
                    </li>
                    <li>
                        <a href="/riwayat" aria-expanded="false"><span
                                class="educate-icon educate-form icon-wrap sub-icon-mg" aria-hidden="true"></span> <span
                                class="mini-click-non">Riwayat Unduh</span></a>
                    </li>
                    <?php endif; ?>
                    ...
                    <li>
                        <a href="/password" aria-expanded="false"><span
                    ...
                    <li>
                        <a href="/logout" aria-expanded="false"><span
                                        ...
                                        <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                            ...
                                            <li class="nav-item">
                                                <a href="#" data-toggle="dropdown" role="button"
                                                    ...
                                                    <img src="<?= session()->has('user_image') ? session('user_image') : '/gambar/sistem/user.png' ?>"
                                                        style="width: 30px;height: 30px; object-fit:cover; object-position:center;">
                                                    <span class="admin-name">
                                                        <?= session()->has('profile') ? session('profile')['nama'] : 'User Marketing' ?>
                                                    </span>
                                ...
                                <ul class="mobile-menu-nav">
                                    ...
                                    <li>
                                        <a href="/staff" aria-expanded="false"><span
                                                ...
                                                aria-hidden="true"></span> <span class="mini-click-non">Staf
                                                Marketing</span></a>
                                    </li>
