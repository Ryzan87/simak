          ...
          <div class="panel-body">
            ...
            <form method="post" action="/kategori/update/<?= $kategori['kategori_id'] ?>">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="nama" value="<?= $kategori['kategori_nama']; ?>" required="required">
              </div>

              <div class="form-group">
                <label>Keterangan</label>
                <textarea class="form-control" name="keterangan" required="required"><?= $kategori['kategori_keterangan']; ?></textarea>
              </div>
